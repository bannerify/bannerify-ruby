...
module OpenApiSDK
  module Shared
    ...
    class ErrNotFoundError < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig

      # A machine readable error code.
      field :code, ::OpenApiSDK::Shared::ErrNotFoundCode, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('code'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::ErrNotFoundCode, false) } }
      ...
      sig { params(code: ::OpenApiSDK::Shared::ErrNotFoundCode, docs: ::String, message: ::String, request_id: ::String).void }
