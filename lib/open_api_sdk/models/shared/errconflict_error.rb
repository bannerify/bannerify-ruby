...
module OpenApiSDK
  module Shared
    ...
    class ErrConflictError < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig

      # A machine readable error code.
      field :code, ::OpenApiSDK::Shared::ErrConflictCode, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('code'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::ErrConflictCode, false) } }
      ...
      sig { params(code: ::OpenApiSDK::Shared::ErrConflictCode, docs: ::String, message: ::String, request_id: ::String).void }
