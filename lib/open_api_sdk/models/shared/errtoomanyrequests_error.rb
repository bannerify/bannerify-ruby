...
module OpenApiSDK
  module Shared
    ...
    class ErrTooManyRequestsError < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig

      # A machine readable error code.
      field :code, ::OpenApiSDK::Shared::ErrTooManyRequestsCode, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('code'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::ErrTooManyRequestsCode, false) } }
      ...
      sig { params(code: ::OpenApiSDK::Shared::ErrTooManyRequestsCode, docs: ::String, message: ::String, request_id: ::String).void }
