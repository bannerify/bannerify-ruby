...
module OpenApiSDK
  module Shared
    ...
    class ErrForbiddenError < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig

      # A machine readable error code.
      field :code, ::OpenApiSDK::Shared::ErrForbiddenCode, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('code'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::ErrForbiddenCode, false) } }
      ...
      sig { params(code: ::OpenApiSDK::Shared::ErrForbiddenCode, docs: ::String, message: ::String, request_id: ::String).void }
